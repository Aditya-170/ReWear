    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-24 pb-16 flex items-center justify-center">
        <div className="w-full max-w-5xl bg-white/5 backdrop-blur-lg rounded-3xl border border-white/10 shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-10 p-8 md:p-14 animate-fade-in">
          ...
          <div>
            <div className="mb-8">
              <label className="block mb-3 font-bold text-lg text-purple-200">
                Main Product Image
              </label>
              {imageFiles.length > 0 ? (
              ...
              <>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    type="button"
                    className="px-4 py-1 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold shadow hover:from-purple-600 hover:to-pink-600 transition-all duration-300"
                  >
                    + Add
                  </button>
                  <input
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <h2 className="text-2xl font-extrabold bg-gradient-to-r from-purple-400 via-pink-400 to-pink-600 bg-clip-text text-transparent mb-2">
              Add New Product
            </h2>
            <input
              name="title"
              ...
              required
              className="px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
            />
            <textarea
              name="description"
            ...
            <button
              type="submit"
              disabled={uploading}
              className="mt-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/40 transition-all duration-300 text-lg"
            >
