                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-2">
                        <div className="text-center">
                            ...
                            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-4">
                                Explore our curated collection of premium items, each carefully
                                        ...
                                        <div className="relative overflow-hidden aspect-square">
                                            ...
                                            {product.status && (
                                                <div className="absolute top-4 right-4">
                                                    <span
                                                        className={`px-3 py-1 rounded-full text-xs font-semibold ${product.status === "Available"
